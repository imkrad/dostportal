    ...
    <BContainer fluid>
        ...
        <template v-if="layoutType === 'vertical' || layoutType === 'semibox'">
            <ul class="navbar-nav h-100" id="navbar-nav">
              <template v-if="checkUrl() == 'hr'">
              <li class="menu-title">
                  <span data-key="t-menu">Services</span>
              </li>
              <li class="nav-item" v-for="(menu,index) in $page.props.menus.hr" v-bind:key="index">
              ...
              <template v-else-if="$page.props.user.data.role == 'Administrator'">
