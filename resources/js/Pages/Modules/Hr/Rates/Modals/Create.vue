<template>
    <b-modal v-model="showModal" size="lg" header-class="p-3 bg-light" :title="(!editable) ? 'Create Rate' : 'Edit Rate'" class="v-modal-custom" modal-class="zoomIn" centered no-close-on-backdrop>
