<template>
    ...
    <!-- {{ dropdowns.lists.data[0].bids_details  }} -->
                ...
                <div class="file-manager-content w-100 p-4 pb-0" style="height: calc(80vh - 180px); overflow: auto;" ref="box">
                    <div>
                        <b-dropdown size="sm" variant="success">
                            ...
                            <b-dropdown-item @click="printBids(item)">
                            <i class="ri-check-double-fill align-bottom me-1"></i> 
                            Print
                            </b-dropdown-item>
                            <b-dropdown-item @click="viewPR()" >
                            <i class="ri-check-double-fill align-bottom me-1"></i> 
                            View
                            </b-dropdown-item>
                        </b-dropdown>
...
export default {
    ...
    methods: { 
        ...
        printBids(data){
            console.log(data);
           window.open('/faims/bids/print/'+data.id+'?pr_id='+ data.purchase_request.id +'&purchase_request_number='+data.purchase_request.purchase_request_number );
        }
