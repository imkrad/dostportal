...
<body>
    ...
    <div class="text-left" style="font-size: 10px; margin-top: 40px;">
        <h3>
            <h3 style="margin-bottom:-30px; margin-left: 230px">
                <span>{{ $supplier->name }}</span>
            </h3>
            <h3>
                Company Name/Business Name:________________________________________________________________
            </h3>
            <h3 style="margin-bottom:-30px; margin-left: 80px">
            ...
            <h3 style="margin-bottom:-30px; margin-left:210px">
                <span>{{ $supplier->mayors_permit_no }}</span>
            </h3>
            <h3>
            ...
            <h3 style="margin-bottom:-30px; margin-left:220px">
                <span>{{ $supplier->philgeps_registration_no }}</span>
            </h3>
            <h3>
    ...
    <div class="border-container2 " style="font-size:11px">
        ...
        <p style="text-indent: 50px; text-align: justify; padding: 10px ">
            <i>
                ...
                than <u>{{ $submission_not_later_than}}</u> at <u>9:00</u> am to the address listed above.
            </i>
        </p>
            ...
            <p style="text-align: center">
                <i>
                    ...
                    <p class=" bold" style="line-height: 1; text-transform: uppercase;">
                        {{ $supply_officer->firstname }} {{ $supply_officer->middlename[0] }}. {{ $supply_officer->lastname }} {{ $supply_officer->suffix }} 
                        <br>
                        <p>
                           <span v-if="supply_officer->role">
                             {{ $supply_officer->role }}
                           </span>
                           <span v-else>
                             Supply Officer
            ...
            <table>
                ...
                @foreach ($item_details as $index => $item)
                    <tr>
                        ...
                        <td style="padding-top:15px">{{ $item->item_quantity }} {{ $item->unit_type['name_long'] }}</td>
                        <td style="padding-top:15px">{{ number_format($item->total, 2) }}</td>
